...
#' If separate bias models for \emph{X} and \emph{U} are desired, use
#' \code{adjust_uc_emc_sel}.
#'
...
#' \emph{Y} is the binary outcome, \emph{C}
...
#' binary outcome, \emph{C} represents the vector of measured confounders
